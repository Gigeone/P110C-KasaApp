...
const Appartement = () => {
  ...
  useEffect(() => {
    ...
    const foundAppartement = appartementsData.find(appart => appart.id === appartementId);
          ...
          <div className='headerDescription'>
              ...
              <div>
                <div className='hostContainer'>
                    ...
                    <img src={appartement.host.picture} alt="Hôte" className='hostPic' />
                </div>
              </div>
              
          </div>
          <div className='tagsContainer'>
              {appartement.tags ? appartement.tags.map(tag => <p key = {tag} className='tag'>{tag}</p>) : null} 
          </div>
          <div>
            <StarRating ratings={appartement.rating} />
          </div>
          <Dropdown label={"Description"} data={appartement.description} />
          <Dropdown label={"Equipements"} data={<ul>
